...
CSV_PATH = f"/home/sghwr/USELESS/code/bt_csi_project/data/csv/devices_{today}.csv"                          # <--- 在这里修改CSV文件路径

# 2. 输出文件（固定）：供Pygame实时读取的JSON文件路径
OUTPUT_JSON = "/home/sghwr/USELESS/code/bt_csi_project/data/json/pygame_data.json"                           # <--- 在这里修改实时输出JSON路径

# 3. 输出文件（每日备份）：带日期的JSON备份文件路径（可选）
OUTPUT_JSON_DAILY = f"/home/sghwr/USELESS/code/bt_csi_project/data/backup/pygame_data_{today}.json"            # <--- 在这里修改备份JSON路径
